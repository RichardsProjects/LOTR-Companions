...
public class AbstractLOTRCompanionEntity extends TameableEntity{
    ...
    public ILivingEntityData finalizeSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn,
        ...
        int baseHealth = 30 + CompanionData.getHealthModifier();
    ...
    public void readAdditionalSaveData(CompoundNBT tag) {
        ...
        if (tag.getInt("baseHealth") == 0) {
            this.setBaseHealth(LOTRCompanions.BASE_HEALTH);
        } else {
    ...
    public AgeableEntity getBreedOffspring(ServerWorld level, AgeableEntity parent) {
        return LOTRCEntity.HIRED_GONDOR_SOLDIER.get().create(level);
    }
