...
public class CompanionScreen extends ContainerScreen<CompanionContainer> implements IHasContainer<CompanionContainer> {
    private static final ResourceLocation CONTAINER_BACKGROUND = new ResourceLocation(LOTRCompanions.MOD_ID,
    ...
    private static final ResourceLocation HUNTING_BUTTON = new ResourceLocation(LOTRCompanions.MOD_ID, "textures" +
            "/huntingbutton.png");
    ...
    protected void renderLabels(MatrixStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (companion instanceof HiredGondorSolider) {
            this.font.draw(pPoseStack, "Gondor Soldier", classLeft, classHeight, 4210752);
        }
