...
public class CompanionRenderer extends BipedRenderer<AbstractLOTRCompanionEntity, PlayerModel<AbstractLOTRCompanionEntity>> {
    ...
    public void render(AbstractLOTRCompanionEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
        this.setModelProperties(p_225623_1_);
        super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
    }

    private void setModelProperties(AbstractLOTRCompanionEntity companion) {
        PlayerModel<AbstractLOTRCompanionEntity> companionModel = this.getModel();
    ...
    private static BipedModel.ArmPose getArmPose(AbstractLOTRCompanionEntity companion, Hand hand) {
    ...
    @Override
    public ResourceLocation getTextureLocation(AbstractLOTRCompanionEntity entity) {
        return entity.getResourceLocation();
    }

    protected void scale(AbstractLOTRCompanionEntity p_117798_, MatrixStack p_117799_, float p_117800_) {
        float f = 0.9375F;
